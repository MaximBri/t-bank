export const EventCardSkeleton = () => (
  <div className="flex min-h-[14px] sm:min-h-[176px] flex-col rounded-[16px] border border-primary bg-secondary p-[10px] sm:p-[20px]">
    <div className="flex items-start justify-between gap-4">
      <span className="h-[20px] w-[137px] sm:w-[214px] rounded-[24px] bg-skeleton" />
