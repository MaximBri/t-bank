      ...
      <div className="flex flex-col rounded-[16px] gap-[20px] sm:gap-[25px] border-[2px] border-primary bg-secondary p-[10px] sm:p-[34px]">
        <div className="flex flex-col">
          <div className="flex gap-[20px]">
            ...
            <div className="flex flex-col">
              ...
              <Text variant="h3" className="mt-auto font-medium hidden sm:block">
        ...
        <div className="flex flex-col gap-[15px]">
          {settlements.map((settlement) => (
            <div
              key={settlement.id}
              className="flex flex-col sm:flex-row p-[10px] sm:px-[20px] sm:py-[10px] bg-primary border-[2px] border-primary rounded-lg"
            >
              <div className="flex-1 flex gap-[20px] items-center">
                ...
                <div className="max-w-[250px] min-w-0">
                  <Text className="font-medium truncate text-h3-d sm:text-h2-d">
