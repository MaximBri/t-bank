...
export const EventParticipantsWidget = () => {
  ...
  return (
    <section className="flex flex-col gap-[15px] sm:gap-[20px]">
      ...
      <div className="flex flex-col gap-[10px] sm:gap-[24px] rounded-lg border-[2px] border-primary bg-secondary p-[10px] sm:p-[24px]">
        <div className="flex flex-col gap-[10px] sm:gap-[16px]">
          ...
          <div className="flex flex-col-reverse gap-[10px] sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button variant={ButtonEnum.Primary} className="w-fit ml-auto">
              <UserPlusIcon className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px]" />
              <Text variant="h3" className="font-normal">
              ...
              >
                ...
                <div className="flex-1 flex flex-col sm:flex-row sm:items-center justify-between">
                  ...
                  <div className="flex gap-[8px] sm:gap-[10px]">
                    <div
                      className={clsx(
                        'inline-flex sm:min-h-[44px] items-center rounded-lg px-[12px] font-medium',
                    ...
                    {!isOwner ? (
                      <button
                        type="button"
                        className="flex items-center px-[8px] sm:px-[12px] sm:py-[10px] rounded-md border border-primary "
